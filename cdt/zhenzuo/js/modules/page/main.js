...
define(function(require, exports, module){
	...
	module.exports = {
		...
		setCurrentLevel : function(){
			...
			//添加分享文案
			var getLevel = self.currentLevel - 1;
			var shareTemp = {
					'title' : shareParam1.title,
					'link' : shareParam1.link,
					'con' : shareParam1.con,
					'img' : shareParam1.img,
			};
            var title = self.replaceScore(shareTemp.title,getLevel);
            shareTemp.title = title;
			self.getShare(shareTemp);
