/**
 *
 *  For 微信Wap 应用 Javascript API
 *  2014/11/04 Update By hongweiyang
 *
 *  功能列表
 *  隐藏/显示右上角的菜单入口
 *  获取当前的网络状态
...
////////////////////////////////////////////// 微信分享}}}
    ...
    /**
     * 当页面加载完毕后执行，使用方法：
     * weChatApi.ready(function(Api){
     *     //   从这里只用Api即是 weChatApi
     * });
     * @param readyCallback
     */
    ...
    return {
        version         :"1.0",
        enableDebugMode :enableDebugMode,       // 测试 debug
        ready           :wxJsBridgeReady,       // WXJS
        
        shareToFriend   :weixinSendAppMessage,  // 分享给好友
        shareToTimeline :weixinShareTimeline,   // 分享到朋友圈
        
        showOptionMenu  :showOptionMenu,        // 显示右上角按钮
        hideOptionMenu  :hideOptionMenu,        // 隐藏右上角按钮
        showToolbar     :showToolbar,           // 显示底部工具栏
        hideToolbar     :hideToolbar,           // 隐藏底部工具栏
        
        scanQRCode      :scanQRCode,            // 打开扫码
        getNetworkType  :getNetworkType,        // 获取当前网络形式
        imagePreview    :imagePreview,          // 调起客户端的图片播放组件
